...
export const questions: Question[] = [
  {
    ...
    answer: 1,
    explanation:
      "在 JavaScript 中，「傳值（Pass by Value）」是指在傳遞變數時，系統會複製一份全新的資料（值）給對方，兩者此後各自獨立、互不影響。",
  },
  {
    id: 2,
    question:
      "以下程式碼執行後，外部的 num 是多少？\n\nfunction addOne(n) {\n  n = n + 1\n}\nlet num = 5\naddOne(num)\nconsole.log(num)",
    options: ["6", "5", "undefined", "NaN"],
    answer: 1,
    explanation:
  ...
  },
  {
    id: 3,
    question:
      "以下程式碼執行後，外部的 user.age 是多少？\n\nfunction birthday(obj) {\n  obj.age = obj.age + 1\n}\nconst user = { age: 25 }\nbirthday(user)\nconsole.log(user.age)",
    options: ["25", "26", "undefined", "ReferenceError"],
    answer: 1,
    explanation:
  ...
  },
  {
    id: 4,
    question:
      "以下程式碼執行後，外部的 user 是什麼？\n\nfunction reset(obj) {\n  obj = { age: 0 }\n}\nconst user = { age: 25 }\nreset(user)\nconsole.log(user.age)",
    options: ["0", "25", "undefined", "null"],
    answer: 1,
    explanation:
