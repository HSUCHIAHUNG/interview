    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">全部回答完畢！</h2>
              ...
              <details key={i} className="border border-gray-200 rounded-xl overflow-hidden">
                ...
                <div className="px-4 pb-4 pt-2 space-y-3 border-t border-gray-100">
                  <div className="bg-blue-50 rounded-lg p-3">
                    <p className="text-xs font-semibold text-blue-600 mb-1">你的回答</p>
                    <p className="text-sm text-gray-700 whitespace-pre-wrap">{r.userAnswer}</p>
                  </div>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-6 leading-relaxed whitespace-pre-wrap">
          {q.question}
        </h2>
        ...
        <textarea
          ...
          rows={5}
          className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-700 resize-none focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent transition disabled:bg-gray-50 disabled:text-gray-500"
        />
        ...
        {phase === 'answer' && (
          <button
            ...
            className="mt-4 w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-200 disabled:cursor-not-allowed text-white disabled:text-gray-400 font-semibold py-3 rounded-xl transition"
          >
            送出，讓 AI 評估
          </button>
        )}
