  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2">
        ...
        <span
          className={`shrink-0 text-xs font-semibold px-2.5 py-1 rounded-full ${DIFFICULTY_COLOR[meta.difficulty]}`}
        >
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <span
          className={`text-xs font-medium px-2.5 py-0.5 rounded-full ${CATEGORY_COLOR[meta.category] ?? 'bg-gray-800 text-gray-400'}`}
        >
          {meta.category}
        </span>
        {subCategory && (
