          ...
          <div className="text-left space-y-3 mb-8">
            {questions.map((q, i) => {
              ...
              return (
                <div
                  key={q.id}
                  className={`p-3 rounded-lg text-sm border ${correct ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'}`}
                >
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-6 leading-relaxed">{q.question}</h2>
        ...
        <div className="space-y-3">
          {q.options.map((opt, idx) => {
            ...
            if (!isAnswered) {
              style += 'border-gray-200 hover:border-blue-400 hover:bg-blue-50 text-gray-700 cursor-pointer'
